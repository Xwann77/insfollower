...
# insfollow v2.0
# recoded by: Xwann
# github.com/Xwann77/insfollower
...
echo -e "\e[1;91m ═╩═\e[1;92m         \e[1;91m╩   by - \e[1;92mXwann Script"
...
curl -L -b cookie.$user -s --user-agent 'User-Agent: "Instagram 10.26.0 Android 
(18/4.3; 320dpi; 720x1280; Xiaomi; HM 1SW; armani; qcom; en_US)"' -w "\n%{http_code}\n" -H "$header" "https://i.instagram.com/api/v1/feed/saved" > $user_account.saved_ig
...
printf " \e[1;33m [-] We have set limit for prevent blockage of your instagram 
account.\n"
exit 1
else
printf " \e[1;92mSuccess\e[0m\n"
